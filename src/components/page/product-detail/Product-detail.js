...
const ProductDetail = () => {
    ...
    const getProductItems = () => {
        setLoading(true)
        axios.get(`https://shopee-nodejs.herokuapp.com/api/products/${params.productId}`)
                        ...
                        {selectedProduct ? (
                            <>
                                <div className="w-40 px-4">
                                    <img src={selectedProduct.productImage} className="d-block w-100" />
                                </div>
                                <div className="w-60">
                                    ...
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <button className="btn btn-outline-secondary border-end-0 py-0" onClick={decrease}>-</button>
                                            <button className="btn btn-outline-secondary py-0" style={{ width: "60px" }}>{productQuantity}
                                            </button>
                                            <button className="btn btn-outline-secondary border-start-0 py-0" onClick={increase}>+</button>
                                        </div>
                                    ...
                                    <div className="d-flex align-items-center">
                                        <button className="btn border-primary text-primary me-2" onClick={addToCart}>
                                            <FontAwesomeIcon
                                                icon="fa-cart-shopping" /> Thêm vào giỏ hàng
                                        </button>
